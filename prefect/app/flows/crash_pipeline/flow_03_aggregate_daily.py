...
from tasks.crash.silver.aggregate_to_daily.extract import select_from_silver_crashes
from tasks.crash.silver.aggregate_to_daily.transform import agregate_to_daily
from tasks.crash.silver.aggregate_to_daily.load import (
...
def execute_tasks(
    ...
    from tasks.crash.silver.aggregate_to_daily.load import create_daily_crashes_table
