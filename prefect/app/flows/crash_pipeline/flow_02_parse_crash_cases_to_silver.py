...
from tasks.crash.silver.parse_crash_cases.extract import select_from_bronze_crashes
from tasks.crash.silver.parse_crash_cases.transform import flatten_crashes_json
from tasks.crash.silver.parse_crash_cases.load import upsert_to_silver
...
def execute_tasks(
    ...
    from tasks.crash.silver.parse_crash_cases.load import (
