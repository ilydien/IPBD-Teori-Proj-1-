...
from tasks.weather.silver.extract_from_openmeteo.extract import fetch_weather_from_api
from tasks.weather.silver.extract_from_openmeteo.load import insert_weather_to_silver, create_weather_table
    ...
    for i, (start_date, end_date) in enumerate(year_batches):
        ...
        for j, loc in enumerate(locations):
            ...
            if i < len(year_batches) - 1 or j < len(locations) - 1:
                time.sleep(1)  # 1 second delay to avoid ban
